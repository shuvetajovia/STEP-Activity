...
class SavingsAccount(Account):
    """Savings account with minimum balance and interest calculation."""
    ...
    def get_minimum_balance(self) -> float:
        return AccountRulesEngine.get_instance().get_minimum_balance("SAVINGS")

    def get_interest_rate(self) -> float:
        return AccountRulesEngine.get_instance().get_interest_rate("SAVINGS")
